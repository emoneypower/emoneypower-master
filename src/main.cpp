...
const string strMessageMagic = "emoneypower Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 2)
  {
    ...
    else if(pindexBest->nHeight+1 >= 11 && pindexBest->nHeight+1 <= 1200000000)
  {
    nSubsidy = 0 * COIN;
  }
...
// emoneypower: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "emoneypower", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "EmoneyPower Coin 2017";
        CTransaction txNew;
        txNew.nTime = 1497080274;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x01ea4e7e3e9f5be1ece0e3af2765da3be3f9327a843922589e7f47d381076d64"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0x2d, 0xa3, 0xf4 };
